...
if( $_POST ) {
	...
	update_user_meta($user_id, 'user_type', $user_type );
        ...
        $subject = 'Your Houseace account has been created!';
        $title = 'Your Houseace account has been created.<br />Here are all details:';
        $text = '<div style="text-align:center; padding:25px 0;">
                ...
                <div style="text-align:center; padding:10px 0;">
                        <a href="' . get_bloginfo('url') . '/sign-in" style="background:#57c7d4; color:#fff; padding:12px 25px; text-decoration:none; font-size:16px; ">Sign In</a>
                </div>';
