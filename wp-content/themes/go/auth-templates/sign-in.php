...
<head>
        ...
        <!--[if lt IE 9]>
                ...
                <body class="page-login-v3 front-bg layout-full">
                        <!--[if lt IE 8]>
                                <p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please <a href="http://browsehappy.com/">upgrade your browser</a> to improve your experience.</p>
                                <![endif]-->
                                <!-- Page -->
                                <div class="page animsition vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out" style="margin:0 auto!important;">
                                <div class="page-content vertical-align-middle">
                                        <div class="panel">
                                                <div class="panel-body">
                                                        <div class="brand">
                                                                <a href="<?php bloginfo('url'); ?>"><img class="brand-img" src="<?php bloginfo('template_url'); ?>/assets/images/housebk.png" alt="Houseace" style="width: 50%"></a>
                                                        </div>
                                                        <form id="sign-in">
                                                            <input type="hidden" name="redirect" value="<?php echo $redirect; ?>">
                                                                ...
                                                                <div class="form-group clearfix">
                                                                        <div class="checkbox-custom checkbox-inline checkbox-danger checkbox-lg pull-left">
                                                                                <input type="checkbox" id="inputCheckbox" name="remember">
                                                                                <label for="inputCheckbox">Remember me</label>
                                                                        </div>
                                                                        <a class="pull-right" href="<?php bloginfo('url'); ?>/reset-password">Forgot password?</a>
                                                                </div>
                                                                <div id="sign-in-response"></div>
                                                                <a id="go-sign-in" class="btn btn-primary btn-block btn-lg margin-top-20 margin-left-0">Sign in</a>
                                                        </form>
                                                        <p>Still no account? Please go to <a href="<?php bloginfo('url'); ?>/sign-up">Sign up</a></p>
                                                </div>
                                        </div>
                        ...
                        <script src="<?php bloginfo('template_url'); ?>/auth-templates/js/sign-in.js"></script>
                        <script>
