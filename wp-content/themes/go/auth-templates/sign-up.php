                                                ...
                                                <div class="panel-body">
                                                        ...
                                                        <form id="sign-up">
                                                               <div class="radio-custom radio-danger row" style="text-align:left">
                                                                        <div class="col-md-6">
                                                                                <input type="radio" id="inputRadiosChecked" value="Client" name="user_type" checked="">
                                                                                <label for="inputRadiosChecked">Client</label>
                                                                        </div>
                                                                        <div class="col-md-6">
                                                                                <input type="radio" id="inputRadiosChecked2" value="Contractor" name="user_type" checked="">
                                                                                <label for="inputRadiosChecked3">Contractor</label>
                                                                        </div>
                                                                </div>
                                                                <div class="row">
                                                                        <div class="col-md-6">
