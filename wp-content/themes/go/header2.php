...
<head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
	      <meta name="description" content="Paynt takes the pain out of painting with instant quotes, hand picked expert painters and our 100% SATISFACTION GUARANTEE ">
...
fbq('init', '1599171203464073'); // Insert your pixel ID here.
fbq('track', 'PageView');
</script>
  
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1599171203464073&ev=PageView&noscript=1"
/></noscript>
<!-- DO NOT MODIFY -->
  ...
  <!-- Site Navbar Seach -->
      <div class="collapse navbar-search-overlap" id="site-navbar-search">
        <form action="/add_quote" method="get" role="search">
          ...
          <a type="button" class="input-search-close inline icon wb-close" data-target="#site-navbar-search"
              data-toggle="collapse" aria-label="Close"></a>
      ...
      <!-- End Site Navbar Seach -->
            ...
            <li class="hidden-xs"><a class="red-700 font-weight-500" href="tel: 0284171038"><i class="icon pe-phone"></i> 02 8417 1038</a></li>
            <li class="visible-xs"><a class="red-700 font-weight-500" href="tel: 0284171038"><i class="icon pe-phone"></i></a></li>
     <?php if(!is_user_logged_in()) : ?> 
	<li>
			 <form action="<?php bloginfo('url'); ?>/sign-in">
			<button class="btn hidden-xs btn-default bg-white btn-raised navbar-btn btn-sm" href="">Login</button>
			<button class="btn btn-default bg-white btn-raised navbar-btn btn-sm" href=""><i class="icon pe-user"></i></button>
		</form>
	</li>
        <?php endif ; ?>		
