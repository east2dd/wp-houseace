                        ...
                        <div data-role="content">
                                <section class="page-aside-section">
                                        ...
                                        <div class="list-group">
                                                ...
                                                <a class="list-group-item <?php if($quote_status == 'pending') { echo 'active'; } ?>" href="<?php bloginfo('url'); ?>/all_projects?status=pending"><i class="icon wb-pause" aria-hidden="true"></i>In Proposal</a>
                                                <a class="list-group-item <?php if($quote_status == 'live') { echo 'active'; } ?>" href="<?php bloginfo('url'); ?>/all_projects?status=live"><i class="icon wb-play" aria-hidden="true"></i>Live</a>
