                ...
                <div data-role="container">
                        <div data-role="content">
                                <section class="page-aside-section">
                                        <h5 class="page-aside-title">All Quotes</h5>
                                        <div class="list-group">
                                                ...
                                                <a class="list-group-item <?php if($quote_status == 'completed') { echo 'active'; } ?>" href="<?php bloginfo('url'); ?>/all_projects?status=completed"><i class="icon wb-check" aria-hidden="true"></i>Completed Quotes</a>
                                                <a class="list-group-item <?php if($quote_status == 'cancelled') { echo 'active'; } ?>" href="<?php bloginfo('url'); ?>/all_projects?status=cancelled"><i class="icon wb-close-mini" aria-hidden="true"></i>Cancelled</a>
                                        </div>
                                </section>
