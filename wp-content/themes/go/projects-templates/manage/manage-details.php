...
$total = getProjectTotal($quote_id); $total = round($total,2); $total = number_format($total, 2, '.', '');
                ...
                <div class="row">
					...
					<table class="table contacts_table" id="default_selections" >
						...
						<tbody>
                                                        ...
                                                        ?>
                                                        <tr valign="middle">
                                                                <td class="text-center" style="width:10%; vertical-align: middle;" id="selection_<?php echo $selection->ID; ?>">
                                                                ...
                                                                <td style="vertical-align: middle;">
                                                                        <?php $brands = wp_get_post_terms($selection->ID,'brand',array('fields'=>'all'));
                                                                        foreach($brands as $brand) { echo $brand->name . " "; } ?>
                                                                </td>
                                                                <td style="vertical-align: middle;">
                                                                ...
                                                                <td style="vertical-align: middle;">
                                                                        <?php $selection_photo_id = get_field('selection_photo',$selection->ID);
                                                                        if($selection_photo_id) :
                                                                        $selection_photo = wp_get_attachment_url($selection_photo_id); ?>
                                                                        <img src="<?php echo $selection_photo; ?>" alt="" width="60px" />
                                                                        <?php endif; ?>
                                                                </td>
                                                        </tr>
                                ...
                                <div style='cursor:pointer; position:relative;' class="padding-vertical-10" data-toggle="collapse" href="#manage_contractor" aria-expanded="false" aria-controls="manage_contractor"><h4 color='blue-grey-800'><i class="icon wb-plus"></i> Assign Contractor</h4></div>
