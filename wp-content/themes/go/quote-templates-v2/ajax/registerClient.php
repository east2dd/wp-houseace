...
if( $_POST ) {
	...
	$user_login = $registerFirstName . "_" . $registerLastName . $rand;
	...
	update_user_meta($user_id, 'user_type', $user_type );
        ...
        $subject = 'Welcome to Houseace.com.au!';
        $title = 'Your account has been created.<br />Here are all details:';
        ...
        if($user_id) {
                ...
                echo json_encode( array("message" => $message, "clientId" => $user_id, "clientName" => $registerFirstName, "status" => 'success') );
                die;
        }
