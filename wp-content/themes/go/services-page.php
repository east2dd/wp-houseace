      ...
      <div class="font-size-50 white font-weight-800 margin-bottom-10"> 
         <?php the_field('header_text'); ?>
          ...
          <div class="font-size-20 white">
              ...
              <a class="margin-top-20 btn btn-lg btn-raised btn-primary font-weight-700 scroll_to" href="#quote" data-offset="50">FREE QUOTE</a>
              <a class="hidden margin-top-20 btn btn-lg bg-white btn-raised btn-outline font-weight-700"  data-toggle="modal" data-target="#quoteform">CONTACT</a>
                  <br/>
                       </div>						
       </div>
     </div>
