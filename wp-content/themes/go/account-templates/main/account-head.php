...
$agent_name = $current_user->user_login;
if(is_agent()) {
...
$schedule = json_encode(getSchedule($current_user_id));
...
<div class="page animsition">
                                                ...
                                                <div class="widget-header-content">
                                                        ...
                                                        <div class="profile-job">
                                                                ...
                                                                <p><?php echo $current_user_data->phone; ?></p>
																									       ...
																									       <a href="<?php bloginfo('url'); ?>/profile/<?php echo $current_user->user_login; ?>" class="btn btn-primary">View Profile</a>
                                ...
                                <div class="panel">
                                        <div class="panel-body nav-tabs-animate">
                                                <ul class="nav nav-tabs nav-tabs-line" data-plugin="nav-tabs" role="tablist">
                                                        ...
                                                        <li role="presentation"><a data-toggle="tab" href="#invoice" aria-controls="invoice" role="tab">Company Settings</a></li>
                                                ...
                                                <div class="tab-content">
                                                        <div class="tab-pane active animation-slide-left" id="personal" role="tabpanel">
                                                                ...
                                                                <div class="form-group form-control-default required">
                                                                        ...
                                                                        <textarea name="address" class="form-control address" id="exampleInputAddress" placeholder="Enter address" required><?php echo $current_user_data->address; ?></textarea>
                                                                </div>
                                                                <div class="form-group form-control-default">
                                                                        <label for="exampleInputAva">Change Profile Photo</label>
  	...
  	<div class="panel-body">
							<div class="blue-grey-800 font-size-30"> Embeding Code </div><p>
			Simply copy the below Iframe code and paste directly on your website, It will allow you customers to quote directly on your website. If youre not tech savy just flick us a messages and we'll do it for you.
			</p><br/>
							<pre><?php echo htmlspecialchars("<iframe src='https://houseace.com.au/embeding/$agent_name/' frameborder='0' width='1000' height='1000' seamless/><p>Your browser doesn't supported iframe!</p></iframe>"); ?></pre>
						</div>
	
																													 
								<div class="blue-grey-800 font-size-30"> Direct Links </div><p>
			The links below each form will lead your customers directly to your quote generator.
			</p>					<br/>																	 
																													   <?php
    $by_project_cnt = 0;
    ...
    ?>
       ...
       <div class="col-md-3 col-xs-6 height-400">

       <figure class="quote_option text-center" >
         <a href="#" title="Edit Quote template"><img src="<?php the_field('template_image',$template->ID); ?>">
                    <figcaption class="margin-top-10">
                      <div class="font-size-20 margin-bottom-30 blue-grey-800"><?php echo $template->post_title; ?></div>
                    </figcaption></a>
                  </figure>
                                                   <style type="text/css">
                                                        input[name=agentToken-<?php echo $template->ID; ?>] {
                                                          pointer-events:none;
                                                        }
                                                        </style>
                                                          <div class="form-group margin-horizontal-20">
                                                            ...
                                                            <div class="input-group input-group-icon">
                                                              <input id="token-<?php echo $template->ID; ?>" name="agentToken-<?php echo $template->ID; ?>" type="text" class="form-control" id="agentToken" placeholder="Not generated" value="http://qwote.com.au/add_quote/?templateId=<?php echo $template->ID; ?>" >
                                                              <span class="input-group-addon copyTokenLink" data-toggle="tooltip" data-placement="top" data-trigger="hover" data-original-title="Copy link to clipboard" title="" style="cursor:pointer;" data-clipboard-target="#token-<?php echo $template->ID; ?>">
    ...
    endforeach;
    if($by_project_cnt == 0) {		
        echo "<div class='font-size-30 blue-grey-800'>Once you've setup your quote templates they will show here.</div>";
    }
    ?>
    ...
    ?>
       ...
       <figure class="quote_option text-center" >
         <a href="<?php echo get_permalink( $template->ID ) ?>" title="Edit Quote template"><img src="<?php the_field('template_image',$template->ID); ?>">
                    <figcaption class="margin-top-10">
                      <div class="font-size-20 margin-bottom-30 blue-grey-800"><?php echo $template->post_title; ?></div>
                    </figcaption></a>
                  </figure>
    ...
    ?>
		...
		<div class="tab-pane animation-slide-left" id="schedule" role="tabpanel">
			<div class="row padding-20 text-center">
				<div id="calendar"></div>
			</div>
		</div>
                                                                ...
                                                                <div class="tab-pane animation-slide-left" id="invoice" role="tabpanel">
                                                                        ...
                                                                        <div class="col-md-6">
                                                                                        <div class="form-group form-control-default required">
                                                                                                ...
                                                                                                <input name="company_name" type="text" class="form-control" id="cname" placeholder="Company Name" value="<?php the_field('company_name','options'); ?>" required>
																																							...
																																							<div class="col-md-6">
                                                                                        <div class="form-group form-control-default required">
                                                                                                <label for="cname">Quote Validity</label>
                                                                                                <input name="quote_validity" type="number" class="form-control" id="valid" placeholder="30" value="<?php the_field('quote_validity','options'); ?>" required>
                                                                                        </div>
                                                                                </div>
                                                                        </div>
                                                                        <div class="row">
                                                                        ...
                                                                        <div class="form-group form-control-default required">
                                                                                ...
                                                                                <textarea name="address" class="form-control address" id="caddress" placeholder="Enter Company address" required><?php the_field('address','options'); ?></textarea>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group form-control-default required">
                                                                                <label for="ipi">Terms & Conditions</label>
                                                                                <textarea name="ipi" class="form-control" id="ipi" placeholder="Terms and Conditions" required><?php the_field('ipi','options'); ?></textarea>
                                                                        </div>
                                                                        <div class="row">
                                                                                <div class="col-md-6">
                                                                                        <div class="form-group form-control-default">
                                                                                                <label for="exampleInputAva">Company Logo</label><small>Optimal Logo size is 120px x 42px, this will sit in the header for your customers.</small>
                                                                ...
                                                                <div class="tab-pane animation-slide-left" id="invoice" role="tabpanel">
                                                                        ...
                                                                        <div class="row margin-top-40">
                                                                                <div class="col-md-6">
                                                                                        <div class="form-group form-control-default required">
                                                                                                <label for="cname">Company Name</label>
                                                                                                <input name="company_name" type="text" class="form-control" id="cname" placeholder="Company Name" value="<?php the_field('invCompany_name','user_' . $current_user_id); ?>" required>
                                                                                        </div>
                                                                                </div>
																																					<div class="col-md-6">
                                                                                        <div class="form-group form-control-default required">
                                                                                                <label for="cname">Quote Validity</label>
                                                                                                <input name="quote_validity" type="number" class="form-control" id="valid" placeholder="30" value="<?php the_field('invquote_validity','user_' . $current_user_id); ?>" required>
                                                                                        </div>
                                                                                </div>
                                                                        </div>
                                                                        <div class="row">
                                                                                <div class="col-md-6">
                                                                                        <div class="form-group form-control-default required">
                                                                                                ...
                                                                                                <input name="company_email" type="email" class="form-control" id="cemail" placeholder="Company E-mail" value="<?php the_field('invEmail','user_' . $current_user_id); ?>">
                                                                                        </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                        <div class="form-group form-control-default required">
                                                                                                <label for="cphone">Company Phone</label>
                                                                                                <input name="company_phone" type="text" class="form-control" id="cphone" placeholder="Company Phone" value="<?php the_field('invPhone','user_' . $current_user_id); ?>" required>
                                                                                        </div>
                                                                                </div>
                                                                        </div>
                                                                        <div class="form-group form-control-default required">
                                                                                <label for="caddress">Company Address</label>
                                                                                <textarea name="address" class="form-control address" id="caddress" placeholder="Enter Company address" required><?php the_field('invAddress','user_' . $current_user_id); ?></textarea>
                                                                        </div>
                                                                        <div class="row hidden">
                                                                                <div class="col-md-6">
                                                                                        <div class="form-group form-control-default required">
                                                                                                <label for="taxname">Tax Name</label>
                                                                                                <input name="tax_name" type="text" class="form-control" id="taxname" placeholder="Tax Name" value="<?php the_field('invTax_name','user_' . $current_user_id); ?>">
                                                                                        </div>
                                                                                </div>
                                                                                <div class="col-md-6">
                                                                                        <div class="form-group form-control-default required">
                                                                                                <label for="tax_value">Tax Value</label>
                                                                                                <input name="tax_value" type="text" class="form-control" id="tax_value" placeholder="Tax Value" value="<?php the_field('invTax_value','user_' . $current_user_id); ?>" required>
                                                                                        </div>
                                                                                </div>
                                                                        </div>
                                                                        <div class="form-group form-control-default required">
                                                                                <label for="ipi">Terms and Conditions</label>
                                                                                <textarea name="ipi" class="form-control" id="ipi" placeholder="Payment Instructions" required><?php the_field('invIpi','user_' . $current_user_id); ?></textarea>
                                                                        </div>
                                                                        <div class="row">
                                                                                <div class="col-md-6">
                                                                                        <div class="form-group form-control-default">
                                                                                ...
                                                                                <div class="col-md-6">
                                                                                       <div class="form-group form-control-default required">
                                                                                               <label for="tax_value">Current Company Logo</label>
                                                                                               <?php $logo = get_field('invLogo','user_' . $current_user_id); $size = "medium"; $clogo = wp_get_attachment_image_src( $logo, $size ); ?>
                                                                                               <?php if($logo) : ?>
                                                                                                       <div><img src="<?php echo $clogo[0]; ?>" alt=""></div>
                                                                                               <?php else : ?>
                                                                                                       <p>No logo yet.</p>
