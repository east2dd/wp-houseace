                                ...
                                <div class="widget widget-shadow text-center">
                                        <div class="widget-header">
                                                <div class="widget-header-content">
                                                        ...
                                                        <a href="<?php bloginfo('url'); ?>/all_projects" class="btn btn-info">See Quotes</a>
                                                </div>
                                        </div>
                                        <div class="widget-footer">
                                                <div class="row no-space">
                                                        ...
                                                        <div class="col-xs-4">
                                                                <strong class="profile-stat-count"><?php echo $current_user_stats->pending; ?></strong>
                                                                <span>Pending</span>
                                                        </div>
                                                   <div class="col-xs-4">
                                                                <strong class="profile-stat-count"><?php echo $current_user_stats->live; ?></strong>
                                                                <span>Accepted</span>
                                                        </div>
                                                </div>
                                        </div>
