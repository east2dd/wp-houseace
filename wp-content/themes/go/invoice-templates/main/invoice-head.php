                        ...
                        <div class="panel-body container-fluid">
                                <div class="row">
                                        <div class="col-md-6">
                                                        ...
                                                        <img class="margin-bottom-20 invoice_logo" src="<?php echo $clogo[0]; ?>" alt="<?php echo $companyName; ?>">
                                                        <address>
                                       ...
                                       <div class="font-size-20 black">Project: <?php echo get_the_title( $quote_id ); ?></div>
                                     ...
                                     <div class="hidden-print"> <?php  echo do_shortcode( '[stripe name="Houseace" prefill_email="true" description="' .$payment['title']. '" amount="' .$stripay. '"]' ); ?>
                                          </div>                  <?php echo $companyInstructions; ?>
                                        </div>
