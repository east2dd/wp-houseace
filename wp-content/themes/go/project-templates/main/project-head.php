			...
			<div class="page-content">
				<div class="text-right manage_from_project">
					...
					<?php // confirmation from client
                                        if($client_approved != true && $status->status == 'pending') :
					?>
					<p class="margin-top-20 project_actions">
						You need to Approve or Cancel project:
						<a class="btn btn-lg btn-success margin-horizontal-10" data-target='#approve' data-toggle='modal' data-quote='<?php echo $quote_id; ?>' class='icon wb-check green-600 approve'>Accept</a>
								...
								<div class="tab-content">
									<div class="tab-pane active" id="mes" role="tabpanel">
										...
										<?php include('views/messages.php'); ?>
                                                                        ...
                                                                        <div class="tab-pane padding-30" id="notes" role="tabpanel">
