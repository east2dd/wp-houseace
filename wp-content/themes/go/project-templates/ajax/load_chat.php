...
if($_POST) {
        ...
        if(is_array($messages)) {
                ...
                if($attachment != '') {
                        ...
                        foreach($attachemnts_to_show as $attach) {
                                if($attach['type'] == 'image') {
                                        $att .= "<a class='attachment_popup' style='display:block; margin:10px;' data-plugin='magnificPopup' data-main-class='mfp-img-mobile' href='" . $attach['link'] . "' ><img style='height: 150px' src='" . $attach['thumb'] . "'></a>";
                                }
                                else {
                ...
                echo "<div class='text-center margin-bottom-20 blue-grey-800 font-size-30'>Ask a Question.</div>";
                die;
        }
