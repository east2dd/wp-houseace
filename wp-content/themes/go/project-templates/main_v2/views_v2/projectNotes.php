...
<div class="project_notes">
        ...
        <?php if($notesPresent != true) : ?>
            <p class="text-center noNotes">There are no notes yet.</p>
        <?php endif; ?>

</div>

<?php if(!is_client()) : ?>
<div class="text-center hidden-print margin-top-20">
                ...
                <div class="col-md-12 col-xs-12">
                        ...
                        <div class="form-group">
                                <select class="form-control" name="noteRole">
                                    ...
                                    <option value="Agent">Houseace Staff</option>
