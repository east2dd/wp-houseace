...
<!-- Chat Box -->
<div class="app-message-chats panel margin-0">
        <div class="chats">
...
<!-- Message Input-->
<form class="app-message-input bg-grey-200">
      ...
      <button style="top:31px; bottom:auto;" class="message-input-btn btn btn-primary message_sent" data-project="<?php echo $quote_id; ?>" type="button">SEND</button>
        <input type='file' name='attach' id='attach' accept="application/pdf,image/*,application/msword" style="display:none;" multiple>
