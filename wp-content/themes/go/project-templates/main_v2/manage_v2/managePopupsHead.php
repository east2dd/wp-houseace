    ...
    <div class='modal-dialog modal-center'>
        <div class='modal-content'>
            <div class='modal-header text-center'>
                ...
                <h4 class='modal-title'>Manage Quote Title</h4>
            </div>
    ...
    <div class='modal-dialog modal-center'>
        <div class='modal-content'>
            <div class='modal-header text-center'>
                ...
                <h4 class='modal-title'>Manage Quote Status</h4>
            </div>
            <div class='modal-body text-center'>
                <div class="form-group">
                    <select class="form-control" name="projectStatus">
                        <option value="quote" <?php if($projectStatus->status == 'quote') { echo "selected"; } ?>>Pre Quote</option>
                        <option value="pending" <?php if($projectStatus->status == 'pending') { echo "selected"; } ?>>Final Quote</option>
                        <option value="live" <?php if($projectStatus->status == 'live') { echo "selected"; } ?>>Accepted Quote</option>
    ...
    <div class='modal-dialog modal-center'>
        <div class='modal-content'>
            <div class='modal-header text-center'>
                ...
                <h4 class='modal-title'>Do you want to remove user?</h4>
            </div>
            <div class='modal-body text-center'>
                <div class="form-group">
    ...
    <div class='modal-dialog modal-center'>
        <div class='modal-content'>
            <div class='modal-header text-center'>
                ...
                <h4 class='modal-title'>Add Quote Manager</h4>
            </div>
            <div class='modal-body text-center'>
                <div class="form-group">
                    <select name="projectAgent" class="form-control selectpicker" data-live-search="true">
                        ...
                        if(!empty($headClients) && is_array($headClients)) {
                            ...
                            echo "<option value='0'>There are no managers yet!</option>";
                        }
                        ?>
                    </select>
                </div>
