...
if($_POST && $_POST['projectId']) {
        ...
        // make Activity row
        $activityText = $changeWho . ' cancelled your quote.';
        ...
        $text = '<p> We have cancelled your quote!</p><p>You can login and re-open or just get back in touch if this is a mistake.  ' . get_bloginfo('url') . '/?p=' . $projectId . '</p>';
