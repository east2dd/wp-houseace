...
<!-- Page -->
  ...
  <section id="main" class="section bg-white">
      ...
      <div class="font-size-40 white font-weight-800 margin-bottom-10"> 
       Hassle-Free Home Improvement</div>
...
<section id="main" class="padding-top-30 bg-white">
       <div class="container">
				<div class="row">
           <div class="col-md-8 col-md-offset-2">
                <div clss="row">  
...
We stay in constant communication with our clients. The end result? Beautiful projects and relationships.
                  ...
                  <i class="icon wb-time margin-bottom-10" aria-hidden="true" style="font-size: 64px;"></i><br/>
								 <div class="font-size-20">
                      <b>We'll Quote in Real-time</b><br/>We dont like wasting your time so when we say we'll give you a quote its done on the same day and usually hour.
                    </div><br/>
                  </div>
						 </div>
     </div>
