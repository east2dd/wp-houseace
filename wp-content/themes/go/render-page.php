...
<div class="text-center white margin-xs-0">
        <div class="font-size-50 margin-bottom-30">Rendering Services</div>
        ...
        Paynt is the quickest and easiest way to get your home professionally rendered. Redering your house, apartment or unit doesn't have to be a chore. In fact, Paynt makes it as painless as possible! Our online platform allows you to build a quote, select colors, book and schedule your paint job without ever leaving home. We offer free color consultations and paint swatch samples with all of our residential painting services, to assist in finding your perfect color, and provide expert customer support whenever you need it, so your process is seamless.						 </div>
					</div>
				</div>
			</div>
<div class="container">
		<div class="bg-grey-100">
				 ...
				 <div class="row">
					 <div class="col-md-12 padding-20 text-center blue-grey-800">
						 ...
						 <div class="col-md-4">
							<div class="font-size-20 bluse-grey-800">
									 CEMENT RENDERING
									 </div><small>Traditional cement rendering is the application of a premixed surface of sand, cement and lime to brick, cement, stone or mud brick. It is often textured, tinted or painted after application.</small>
						 </div>
						 <div class="col-md-4">
                   <div class="font-size-20 bluse-grey-800">
									 ACRYLIC RENDERING
									 </div><small>Acrylic is a unique material comprising a mixture of plastic polymers and petroleum that provides its strong and flexible structure. Acrylic-based renders offer better water resistance than cement renders, as well as higher strength against the piercing sun.</small>
						 </div>
						 <div class="col-md-4">
							 <div class="font-size-20 bluse-grey-800">
									 COLOUR RENDERING
									 </div><small>AKA 100% Acrylic solution, This is the same finish as the acrylic system but its not a mixutre of material. The finish is usually tinted to a colour, and it hold the same water and sun resistance as a mixed system. </small>
						 </div>
						 </div>
					</div>
	</div>
	...
	<div id="reviews" class="container">		
		<div class="row">
			...
			<div class="bg-grey-200 padding-50">
				...
				<div class="col-md-4">
					<a class="btn btn-primary btn-block btn-lg btn-raised" href="/add_quote/?templateId=11405">GET A FREE QUOTE</a>
				</div>
			</div>
			</div>
						</div>

	<div id="how-it-works" class="padding-50">
             <div class="text-center white padding-20">
                 <div class="font-size-50 blue-grey-700">
                      How It Works
                    </div>
							 <p class="font-size-20 blue-grey-600">
                Then easiest way to paint your home or office.
							 </p>
                  </div>
		<div class="row no-space">
                <div class="col-sm-6 hidden-xs">
                <div class="vertical-align text-center blue-grey-700 padding-30 height-300"> 
								<div class="vertical-align-middle font-size-20">
Receive an accurate quote in just 2 mins, select colors, and even book online. Don't forget to take advantage of our free samples & color consultations!
									</div></div></div>

                <div class="col-sm-6">
                  <div class="vertical-align text-center bg-red-700 white padding-30 height-300">
                    <div class="vertical-align-middle font-size-40">
                       <i class="icon pe-calculator" aria-hidden="true" style="font-size: 64px;"></i><br/>
                     1.<br/> Get a Quote.
                    </div>
                  </div>
                </div>
			...
			<div class="row no-space">
				 <div class="col-sm-6">
                  <div class="vertical-align text-center bg-red-700 white padding-30 height-300">
                    <div class="vertical-align-middle font-size-40">
                      <i class="icon pe-gleam" aria-hidden="true" style="font-size: 64px;"></i><br/>
                     2.<br/> We Manage.
                    </div>
                  </div>
                </div>
                ...
                <div class="vertical-align text-center blue-grey-700 padding-30 height-300"> 
								<div class="vertical-align-middle font-size-20">
                     You will be instantly connected with a Job Manager. This is your single point of contact who is dedicated to ensuring you are satisfied from start to finish!
									</div></div></div>
	 ...
	 <section class="section section-feature bg-grey-100 section-small">
	<div class="container">
		<div class="col-md-8">
