<?php
/*
Template Name: services single flooring
*/
...
<section id="main" data-spy="scroll" class="section <?php the_field('bg_class'); ?>">
       <div class="container">
				<div class="row padding-top-80 hidden">
           <div class="col-md-10 text-center col-md-offset-1">
                <div clss="row">  
      <div class="font-size-60 white font-weight-800 margin-bottom-10"> 
         <?php the_field('header_text'); ?>
 </div>
          <div class="font-size-20 white">
                    <?php the_field('header_text_below'); ?>
                  </div>
              <div class="margin-top-40 row padding-5">
          ...
          <div class="col-md-7 col-xs-9 padding-0">
         <select data-plugin="selectpicker" data-style="btn-lg bg-white" style="border-bottom: 1px solid" class="show-tick form-control" name="templateId" id="templatId">
                    ...
                    <option data-icon="pe-keypad" value="14134">Stain my Timber Floors</option>
                    <option data-icon="pe-keypad" value="14235">Lime/White Wash my Timber Floors</option>
                    <option data-icon="pe-keypad" value="10309">Bleach my Timber Floors</option>
                     </optgroup>
                  </select>
           </div>
          <div class="col-md-3 col-xs-3 padding-0">
            <button type="submit" class="margin-left-5 hidden-xs btn btn-lg btn-block btn-primary btn-raised"><b>LETS GO</b></button>
            <button type="submit" class="margin-left-5 visible-xs btn btn-lg btn-primary btn-raised"><b>GO</b></button>
              </div>
            </form>
             </div>
              <br/>
