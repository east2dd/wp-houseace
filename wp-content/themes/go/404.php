...
<?php get_header(); ?>
	 ...
	 <!-- Hero -->
  <section class="site-hero bg-red-600 hero padding-50">
    <div class="container text-center">
      <div class="content">
        <div class="font-size-40 white">You seem a little lost.....</div>
<div class="font-sie-30 white">
  Get a quote below or head <a class="inline btn btn-primary btn-sm btn-raised" href="/">home</a> for more reading.
        </div>
      </div>
    </div>
  </section>
